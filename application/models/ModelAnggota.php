...
{
    public $table = "anggota as a";
    public $table_ = "anggota";
    public $table1 = "pangkat as p";
    public $table3 = "jabatan as j";
    public $table2 = "kelompok as k";
    public $column_order = array(null, 'nrp', 'nama', 'nama_pangkat'); //field yang ada di table 
    public $column_search = array('nrp', 'nama', 'nama_pangkat'); //field yang diizin untuk pencarian 
    public $order = array('id_anggota' => 'desc'); // default order 
    ...
    public function ReadPangkat()
    {
        $this->db->select('p.nama_pangkat, p.id_pangkat');
    ...
    {
        $this->db->select('j.nama_jabatan, j.id_jabatan');
    ...
    {
        $this->db->select('a.nrp, a.nama, p.nama_pangkat, a.id_anggota, j.nama_jabatan');
        $this->db->from($this->table, $this->table1, $this->table3);
        $this->db->join($this->table1, 'a.id_pangkat = p.id_pangkat', 'inner');
        $this->db->join($this->table3, 'a.id_jabatan = j.id_jabatan', 'inner');
    ...
    function get($id)
    {
        ...
        return $this->db->get_where($this->table_, $this->req->id('id_anggota', $id))->row();
    }
