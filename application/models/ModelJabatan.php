...
{
    public $table = "jabatan as p";
    public $table1 = "jabatan";
    public $column_order = array(null, 'nama_jabatan'); //field yang ada di table 
    public $column_search = array('nama_jabatan'); //field yang diizin untuk pencarian 
    public $order = array('id_jabatan' => 'desc'); // default order 
