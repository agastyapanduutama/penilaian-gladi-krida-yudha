...
class ModelSoalKelompok extends CI_Model
{
    ...
    public $column_order = array(null, 's.aspek', 's.maks'); //field yang ada di table 
    public $column_search = array('s.aspek', 's.maks'); //field yang diizin untuk pencarian 
    public $order = array('id_soal_kelompok' => 'desc'); // default order 
    ...
    function get($id)
    {
        return $this->db->get_where($this->table2, array('sha1(id_soal_kelompok)' => $id))->row();
    }
