...
class ModelKelompok extends CI_Model
{
    ...
    public $column_order = array(null, 'nama_kelompok'); //field yang ada di table 
    public $column_search = array('nama_kelompok'); //field yang diizin untuk pencarian 
    ...
    function get($id)
    {
        return $this->db->get_where($this->table, array('sha1(id_kelompok)' => $id))->row();
    }
