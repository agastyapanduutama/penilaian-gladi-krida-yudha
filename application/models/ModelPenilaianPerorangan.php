...
class ModelPenilaianPerorangan extends CI_Model
{
    ...
    public $column_order = array(null, 'a.nama', null, 'a.nrp', 'k.nama_kelompok'); //field yang ada di table 
    public $column_search = array('a.nama', 'a.nrp', 'k.nama_kelompok'); //field yang diizin untuk pencarian 
    ...
    {
        $this->db->select('soalp.id_soal_perorangan, soalp.indeks, soalp.tindakan_macam, soalp.nilmax');
