    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between">
            <h3 class="card-title">
                ...
                Lasporan Penilaian Kelompok</h3>

        </div>
        <div class="table-responsive">
            <table class="table card-table table-striped table-vcenter text-nowrap datatable mb-0 table-sm" id="DTPenilaianKelompok">
                <thead>
                    <tr>
                        <th class="letter-spacing" style="font-size:15px">Nama kelompok</th>
                        <th class="letter-spacing" style="font-size:15px">Jumlah anggota</th>
