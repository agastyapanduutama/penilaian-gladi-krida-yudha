...
<section class="container mt-3">
    <div class="card">
        ...
        <div class="table-responsive">
            <table class="table card-table table-striped table-vcenter text-nowrap datatable mb-0 table-sm" id="listnajabatan">
                <thead>
                    <tr>
                ...
                <form id="formAddPangkat">
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            ...
                            <input type="text" class="form-control" name="nama_jabatan" placeholder="PANGLIMA" required>
                        </div>
                        <!-- /Nama Jabatan -->
            ...
            <div class="modal-body my-1">
                ...
                <form id="formEditPangkat">
                    <div class="row">
                        ...
                        <input type="hidden" class="form-control" name="id_jabatan" id="idData" placeholder="KOGAB" required>

                        <!-- Nama Jabatan -->
                        <div class="col-lg-2"></div>
                        <div class="col-lg-8">
                            <label class="form-label">Nama jabatan</label>
                            <input type="text" class="form-control" name="nama_jabatan" id="nama_jabatan1" placeholder="KOGAB" required>
                        </div>
                        <!-- /Nama Jabatan -->
...
<script>
    ...
    $('#listnajabatan').on('click', '#edit', function() {
        let id = $(this).data('id');
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                $("#idData").val(response.id_jabatan)
    ...
    $('#listnajabatan').on('click', '#delete', function() {
        let id = $(this).data('id');
