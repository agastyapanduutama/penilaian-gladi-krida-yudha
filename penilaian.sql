...
-- Dumping database structure for penilaian
CREATE DATABASE IF NOT EXISTS `penilaian` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `penilaian`;

-- Dumping structure for table penilaian.aktivitas
CREATE TABLE IF NOT EXISTS `aktivitas` (
  ...
  KEY `id_kelompok_2` (`id_kelompok`),
  KEY `id_ceklis` (`id_ceklis`),
  CONSTRAINT `aktivitas_ibfk_1` FOREIGN KEY (`id_ceklis`) REFERENCES `ceklis` (`id_ceklis`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `aktivitas_ibfk_2` FOREIGN KEY (`id_kelompok`) REFERENCES `kelompok` (`id_kelompok`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4;

-- Dumping data for table penilaian.aktivitas: ~4 rows (approximately)
/*!40000 ALTER TABLE `aktivitas` DISABLE KEYS */;
INSERT IGNORE INTO `aktivitas` (`id_aktivitas`, `id_kelompok`, `id_ceklis`, `h`, `h1`, `h2`, `h3`, `tgl`, `tipe`) VALUES
	(1, 1, 'C35', 5, 5, 4, 4, '2020-07-20 23:45:38', '2'),
	(2, 2, 'C35', 3, 2, 3, 4, '2020-07-20 23:46:55', '2'),
	(3, 2, 'C36', 5, 4, 3, 2, '2020-07-20 23:52:59', '3'),
	(4, 1, 'C36', 10, 10, 10, 10, '2020-07-21 01:16:36', '3');
/*!40000 ALTER TABLE `aktivitas` ENABLE KEYS */;

-- Dumping structure for table penilaian.anggota
CREATE TABLE IF NOT EXISTS `anggota` (
  ...
  CONSTRAINT `ANGGOTA_ibfk_1` FOREIGN KEY (`id_pangkat`) REFERENCES `pangkat` (`id_pangkat`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `ANGGOTA_ibfk_2` FOREIGN KEY (`id_kelompok`) REFERENCES `kelompok` (`id_kelompok`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `ANGGOTA_jabatan` FOREIGN KEY (`id_jabatan`) REFERENCES `jabatan` (`id_jabatan`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=699 DEFAULT CHARSET=utf8mb4;

-- Dumping data for table penilaian.anggota: ~172 rows (approximately)
/*!40000 ALTER TABLE `anggota` DISABLE KEYS */;
INSERT IGNORE INTO `anggota` (`id_anggota`, `id_jabatan`, `id_pangkat`, `id_kelompok`, `nrp`, `nama`, `password`) VALUES
	(527, 9, 1, 1, '11940027940773', 'Edi Saputra, S.I.P.', NULL),
	(528, 10, 2, 1, '523352', 'I Gusti Putu Setia D, S.T., M.M.', NULL),
	(529, 11, 4, 1, '11960044180874', 'Deni Sukwara, S.E., M.Si.', NULL),
	(530, 11, 13, 1, '-', 'Mamao Monis Tandayao (Filipina)', NULL),
	(531, 12, 1, 1, '11960039310274', 'Safta Feryansyah, S.E., S.I.P.', NULL),
	(532, 12, 3, 1, '12617/P', 'Muhammad Nizar Gadafi, S.E.', NULL),
	(533, 12, 1, 1, '11960051260775', 'Wulang Nur Yudhanto', NULL),
	(534, 12, 2, 1, '518843', 'Ridha Hermawan, S.H.', NULL),
	(535, 13, 1, 1, '11950044840774', 'Surya Wibawa Suparman', NULL),
	(536, 13, 3, 1, '12262/P', 'Arya Delano, S.E., MPD.', NULL),
	(537, 13, 1, 1, '11970039301175', 'Ferry Irawan, S.I.P.', NULL),
	(538, 13, 14, 1, '520294', 'Visnu Hermawan, S.E., M.M.', NULL),
	(539, 14, 1, 1, '11950038580771', 'Teguh Pudji Rahardjo', NULL),
	(540, 14, 3, 1, '11897/P', 'I Komang Teguh A, S.T., M.AP.', NULL),
	(541, 15, 15, 1, '11950050690571', 'Wiwin Sugiono, S.I.P.', NULL),
	(542, 15, NULL, 1, '12702/P', 'Ferry Mulyadi Arifin', NULL),
	(543, 16, 1, 1, '11970044900676', 'Mohammad Sjahroni, S.E.', NULL),
	(544, 16, 16, 1, '68080524', 'I Ketut Yudha Karyana, S.I.K.', NULL),
	(545, 17, 1, 1, '11960048970275', 'Erwin, S.I.P.', NULL),
	(546, 17, NULL, 1, '517477', 'Djoko Triono', NULL),
	(547, 18, NULL, 1, '11960047231274', 'Wijang Rimoko Ardani, S.Sos.', NULL),
	(548, 18, NULL, 1, '73060608', 'Akhmad Yusep gunawan, S.H., S.I.K.', NULL),
	(549, 9, NULL, 2, '11459/P', 'Mauriadi, S.E.', NULL),
	(550, 10, 6, 2, '11960045901074', 'Otto Sollu, S.E.', NULL),
	(551, 11, 1, 2, '11970037570875', 'Aji Mimbarno, S.A.P.', NULL),
	(552, 11, 16, 2, '73040543', 'Guruh Arif Darmawan, S.I.K., M.H.', NULL),
	(553, 12, 3, 2, '12624/P', 'Rakhmat Arief Bintoro, S.Kel.', NULL),
	(554, 12, 1, 2, '11960032610173', 'Muhammad Aidi, S.I.P., M.Si.', NULL),
	(555, 12, 2, 2, '523357', 'A. Donie Prihandono, S.E.', NULL),
	(556, 13, 3, 2, '12644/P', 'Wawan Trisatya Atmaja, S.E.', NULL),
	(557, 13, 1, 2, '11960034440473', 'Renal Aprindo Sinaga', NULL),
	(558, 13, 2, 2, '521812', 'Ali Gusman, S.T., M.M.', NULL),
	(559, 13, 1, 2, '11970036820875', 'Maychel Asmi, P.Sc., S.E.', NULL),
	(560, 14, 3, 2, '12647/P', 'Dores Afrianto Ardi, S.E., M.Si.', NULL),
	(561, 14, NULL, 2, '11960040790474', 'Ari Estefanus, S.Sos., M.Sc.', NULL),
	(562, 15, NULL, 2, '11964/P', 'Sunaryadi, S.E., M.Si.', NULL),
	(563, 15, 1, 2, '11970040521175', 'Susanto Lastua Manurung, S.I.P.', NULL),
	(564, 16, 3, 2, '10683/P', 'Uki Prasetia, S.T., M.M.', NULL),
	(565, 16, 6, 2, '69100444', 'Dr. Hadi Utomo, S.H., M.Hum.', NULL),
	(566, 17, NULL, 2, '521835', 'Darmawan Hendro W, M.Eng.Sc.', NULL),
	(567, 17, 15, 2, '11970048700474', 'Brantas Suharyo G', NULL),
	(568, 18, NULL, 2, '521755', 'Rudy Nursofjan, S.T.', NULL),
	(569, 18, 5, 2, '11980060491175', 'Zulhadrie S Mara', NULL),
	(570, 9, NULL, 3, '11970050420875', 'Johanes Toar Pioh, S.I.P., M.Si. (Han)', NULL),
	(571, 10, 3, 3, '11923/P', 'Oky IZ Dipura, S.H., M.P.A.', NULL),
	(572, 11, NULL, 3, '521806', 'Arman Rusmanto, S.T.', NULL),
	(573, 11, NULL, 3, '-', 'JD Masurkar (India)', NULL),
	(574, 12, 1, 3, '11950036641270', 'Andi Asmara Dewa', NULL),
	(575, 12, NULL, 3, '12713/P', 'Kresno Pratowo, S.E.', NULL),
	(576, 12, 1, 3, '11960051420875', 'Agus Bhakti, S.I.P.', NULL),
	(577, 13, 1, 3, '11950043771172', 'Musa David M. Hasibuan, S.I.P.', NULL),
	(578, 13, 3, 3, '12627/P', 'Endra Hartono, S.H.', NULL),
	(579, 13, 4, 3, '11960050010375', 'Marthen Venry Rorintulus, S.E.', NULL),
	(580, 13, NULL, 3, '521782', 'Arif Budiyanto, S.E.', NULL),
	(581, 14, 6, 3, '11950049971173', 'Donova Pri Pamungkas', NULL),
	(582, 14, 3, 3, '11906/P', 'Adi Lumaksana, S.Sos.', NULL),
	(583, 15, 5, 3, '11960052171073', 'Vincentius Agung Cahya K, S.I.P.', NULL),
	(584, 15, NULL, 3, '11926/P', 'Siswanto, S.T., M.T.', NULL),
	(585, 16, 1, 3, '11960043920874', 'M. Taufiq Zega, S.I.P., M.Si.', NULL),
	(586, 16, NULL, 3, '521785', 'Benny Bayu Nirwan, S.T.', NULL),
	(587, 17, 1, 3, '11960050920675', 'Jones Sasmita Muliawan, S.I.P., M.M.', NULL),
	(588, 17, NULL, 3, '72070702', 'E. Zulpan, S.I.K., M.Si.', NULL),
	(589, 18, 1, 3, '11980053710877', 'Aulia Dwi Nasrullah', NULL),
	(590, 18, 16, 3, '70090398', 'Nanang Masbudi, S.I.K., M.Si.', NULL),
	(591, 9, 2, 3, '521845', 'Jhonson Henrico Simatupang', NULL),
	(592, 10, 4, 3, '11970049460175', 'Candy Cristian Riantory, S.I.P.', NULL),
	(593, 11, 3, 3, '11908/P', 'Henricus Prihantoko', NULL),
	(594, 11, 16, 3, '72030201', 'Rickynaldo Chairul, S.I.K., M.M.', NULL),
	(595, 12, NULL, 3, '520244', 'Budi Setyo, S.H.', NULL),
	(596, 12, 1, 3, '11970034500375', 'Purnomosidi, S.I.P., M.AP.', NULL),
	(597, 12, NULL, 3, '11931/P', 'Reza Kusumanegara, M.A.P.', NULL),
	(598, 13, 2, 3, '521759', 'Bambang Sudewo', NULL),
	(599, 13, 1, 3, '11960044260974', 'Horasman Pakpahan, S.I.P.', NULL),
	(600, 13, NULL, 3, '12732/P', 'Agus Gunawan Wibisono, S.H., M.M.', NULL),
	(601, 13, 1, 3, '11970041440176', 'Willy Brodus Yos Rohadi', NULL),
	(602, 8, 4, 3, '5', '3', NULL),
	(603, 14, 2, 3, '523392', 'Toto ginanto, S.T., M.AP.', NULL),
	(604, 14, 1, 3, '11970033930275', 'Hendi Ahmad Pribadi, S.I.P.', NULL),
	(605, 15, 3, 3, '13292/P', 'Wahyu Cahyono, S.T., M.M.', NULL),
	(606, 15, 1, 3, '11960052741074', 'Herfin Kartika Aji, S.I.P.', NULL),
	(607, 16, 2, 3, '521832', 'Purwanto Adi Nugroho', NULL),
	(608, 16, 1, 3, '11960044420974', 'Chrisbianto Arimurti', NULL),
	(609, 17, 1, 3, '11980053220777', 'Andre Julian, S.I.P., M.Sos.', NULL),
	(610, 17, 16, 3, '70090406', 'Leonardus Eric Bhismo, S.I.K., S.H., M.Hum.', NULL),
	(611, 18, NULL, 3, '520299', 'Rudiyanto, S.T., M.M.', NULL),
	(612, 18, 1, 3, '11970032110774', 'Muhammad Thohir', NULL),
	(613, 9, 2, 4, '523407', 'Rony Armanto, S.E., M.M.', NULL),
	(614, 10, 1, 4, '11970042350376', 'Tamimi Hendra Kesuma, S.H., M.A.P.', NULL),
	(615, 11, 1, 4, '11950043020972', 'Lalu Habibburrahim WD, S.I.P. M.Si.', NULL),
	(616, 11, NULL, 4, '-', 'Muhammad Anjum Saeed (Pakistan)', NULL),
	(617, 12, 2, 4, '523332', 'Andreas Ardianto D, S.E., M.Si. (Han)., M.sc.', NULL),
	(618, 12, 1, 4, '11960048630275', 'Andrian Susanto, S.I.P.', NULL),
	(619, 12, 3, 4, '11888/P', 'Baharudin Anwar, S.T., M.M.', NULL),
	(620, 12, 1, 4, '11970043670576', 'Endra Saputra Kusuma, ZR., S.E.', NULL),
	(621, 13, 2, 4, '521877', 'Henri Ahmad Badawi', NULL),
	(622, 13, 1, 4, '11960039640274', 'Slamet Riadi, S.I.P.', NULL),
	(623, 13, NULL, 4, '11994/P', 'Dede Harsana', NULL),
	(624, 13, 1, 4, '11970041510176', 'Patar Mospa Natanael Sitorus', NULL),
	(625, 14, NULL, 4, '521823', 'Saeful Rakhmat', NULL),
	(626, 14, 1, 4, '11960048061274', 'Teddy Arifiyanto Setimiharja, S.I.P.', NULL),
	(627, 15, 2, 4, '523405', 'Rizaldy Efranza, S.T.', NULL),
	(628, 15, 16, 4, '70121127', 'Djadjuli, S.I.K., M.Si.', NULL),
	(629, 16, 4, 4, '1195005317', 'Harvin Kidingalio', NULL),
	(630, 16, 16, 4, '74040735', 'Didi Hayamansyah, S.H., S.I.K., M.H.', NULL),
	(631, 17, 2, 4, '523397', 'Antonius Adi Nur W, S.E.', NULL),
	(632, 17, 1, 4, '11960046401174', 'Mochamad Andi Prihantoro', NULL),
	(633, 18, 7, 4, '12688/P', 'Abraham OP Sahureka, S.T., MMT.', NULL),
	(634, 18, NULL, 4, '74020330', 'Abdul Karim, S.I.K., M.Si.', NULL),
	(635, 9, 1, 4, '11970044330576', 'Yudha Rismansyah', NULL),
	(636, 10, 3, 4, '11357/P', 'Sumartono, S.E.', NULL),
	(637, 11, 1, 4, '11960049050275', 'Yuri Elias Mamahi', NULL),
	(638, 11, 16, 4, '71010253', 'F. Barung Mangera, S.I.K.', NULL),
	(639, 12, 6, 4, '11950049891173', 'Haerus Shaleh, S.Sos.', NULL),
	(640, 12, 2, 4, '523339', 'R. Endri Kargono', NULL),
	(641, 12, 3, 4, '13278/P', 'Tunggul', NULL),
	(642, 13, 1, 4, '11960043500874', 'Andy Mustafa Akad, S.E.', NULL),
	(643, 13, 3, 4, '11924/P', 'Irwan SP. Siagian', NULL),
	(644, 13, NULL, 4, '523330', 'Rano Kristiyono, S.T.', NULL),
	(645, 13, 1, 4, '11970045320776', 'Fransiscus Ari Susetio, S.E.', NULL),
	(646, 14, 1, 4, '11970032520974', 'Riza Anom Putranto, S.I.P., M.Si.', NULL),
	(647, 8, 4, 4, '5', '3', NULL),
	(648, 14, 2, 4, '523361', 'Jajang Setiawan, S.M.', NULL),
	(649, 15, 15, 4, '11960039720274', 'Wahyudi Dwi Santoso, S.E.', NULL),
	(650, 15, 16, 4, '74090552', 'Hando Wibowo, S.I.K., M.Si.', NULL),
	(651, 16, 1, 4, '11970045990876', 'Ade David Siregar', NULL),
	(652, 16, NULL, 4, '520298', 'Mukhtar Bakhrong, S.E., M.M.', NULL),
	(653, 17, 1, 4, '11950037830671', 'Jaelan, S.I.P.', NULL),
	(654, 17, 2, 4, '523401', 'Erick Rofiq Nurdin', NULL),
	(655, 18, 1, 4, '11960047801274', 'Dody Triwinarto, S.I.P.', NULL),
	(656, 18, 7, 4, '10769/P', 'Yudi Harsono, S.T.', NULL),
	(657, 9, 3, 5, '11364/P', 'Kunto Tjahjono, S.E.', NULL),
	(658, 10, 1, 5, '11940027450573', 'M. Arif Suryandaru', NULL),
	(659, 11, NULL, 5, '518840', 'Videon Nugroho S, S.T.', NULL),
	(660, 11, 13, 5, '-', 'Maxmillion Goh (Singapura)', NULL),
	(661, 12, 3, 5, '13288/P', 'Harry Setiawan, S.E.', NULL),
	(662, 12, 2, 5, '518852', 'Mochammad Untung Suropati, S.E.', NULL),
	(663, 12, 1, 5, '11970057371075', 'Edwin Adrian Sumantha, S.H., PG Dipl.', NULL),
	(664, 13, 3, 5, '11920/P', 'Bayu Alisyahbana, S.M.', NULL),
	(665, 13, NULL, 5, '11960030970572', 'Teguh Heri, S.E., M.M.', NULL),
	(666, 13, 2, 5, '523340', 'Lilik Eko Susanto, S.E., M.M.', NULL),
	(667, 13, 1, 5, '11970043420476', 'Jarot Suprihanto', NULL),
	(668, 14, 3, 5, '11915/P', 'Bagus Handoko, S.H., M.Si.', NULL),
	(669, 14, 1, 5, '11960032041072', 'Agus Soeprianto', NULL),
	(670, 15, NULL, 5, '11395/P', 'Ahmad Alfajar, S.T.', NULL),
	(671, 15, 6, 5, '11970048050676', 'Yudi Prasetio, S.I.P.', NULL),
	(672, 16, NULL, 5, '11934/P', 'Christanto Pratomo, S.T., M.A.P.', NULL),
	(673, 16, 5, 5, '11970054630576', 'M. Andhy Kusuma, S.Sos., M.M.', NULL),
	(674, 17, 1, 5, '11980041500375', 'Sutrisno Pujiono, S.E., M.M.', NULL),
	(675, 17, 16, 5, '74050394', 'Muji Ediyanto, S.H., S.I.K.', NULL),
	(676, 18, 1, 5, '11940011500969', 'Wahyu Handoyo, S.I.P.', NULL),
	(677, 18, 16, 5, '71030329', 'Christiyanto Goetomo, S.I.K., S.H., M.H.', NULL),
	(678, 9, NULL, 5, '12738/P', 'Didiet Hendra Wijaya, MMP.', NULL),
	(679, 10, NULL, 5, '521754', 'Nana Setiawan, S.E.', NULL),
	(680, 11, 1, 5, '11950048230574', 'Franz Yohannes Purba, S.I.P.', NULL),
	(681, 11, 2, 5, '523412', 'Feri Yunaldi, S.E.', NULL),
	(682, 12, NULL, 5, '11481/P', 'Arif Handono, S.A.P.', NULL),
	(683, 12, 1, 5, '11960046811174', 'Deki Zulkarnaen, S.I.P.', NULL),
	(684, 12, 2, 5, '523390', 'Vincentius Endy, H.P.', NULL),
	(685, 13, NULL, 5, '11470/P', 'Amir Kasman, S.E., M.M.', NULL),
	(686, 13, 1, 5, '11960047561274', 'Asep Sukarna, S.Sos., S.I.P., M.M.', NULL),
	(687, 13, 2, 5, '523341', 'Sidik Setiyono, S.E.', NULL),
	(688, 13, 1, 5, '11970043340476', 'Adek Chandra Kurniawan', NULL),
	(689, 14, NULL, 5, '11412/P', 'Agung Setiawan', NULL),
	(690, 14, 1, 5, '11970037650975', 'Iwan Setiawan, S.I.P.', NULL),
	(691, 15, NULL, 5, '11963/P', 'DR. Hery Setiyo N, S.E., M.AP.', NULL),
	(692, 15, 16, 5, '71050218', 'Chaidir, S.H., S.I.K., M.Si., M.P.P.', NULL),
	(693, 16, 3, 5, '11885/P', 'Anung Sutanto, S.Sos., M.Si.', NULL),
	(694, 16, 5, 5, '11970053720575', 'Asep Rahmat Sukmana, S.I.P.', NULL),
	(695, 17, 2, 5, '523345', 'Roni Widodo', NULL),
	(696, 17, 1, 5, '11940023310572', 'Yudi Ruskandar, S.I.P.', NULL),
	(697, 18, 7, 5, '11416/P', 'Budiman Marpaung, S.T., S.E.', NULL),
	(698, 18, 16, 5, '74060705', 'Dayan Victor Imanuel Blegur, S.I.K., M.H.', NULL);
/*!40000 ALTER TABLE `anggota` ENABLE KEYS */;

-- Dumping structure for table penilaian.ceklis
CREATE TABLE IF NOT EXISTS `ceklis` (
  ...
  PRIMARY KEY (`id_ceklis`),
  UNIQUE KEY `id_ceklis` (`id_ceklis`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Dumping data for table penilaian.ceklis: ~36 rows (approximately)
/*!40000 ALTER TABLE `ceklis` DISABLE KEYS */;
INSERT IGNORE INTO `ceklis` (`id_ceklis`, `nama_ceklis`, `tipe`) VALUES
...
/*!40000 ALTER TABLE `ceklis` ENABLE KEYS */;

-- Dumping structure for table penilaian.detail_penilaian_kelompok
CREATE TABLE IF NOT EXISTS `detail_penilaian_kelompok` (
  `id_detail_penilaian_kelompok` int(11) NOT NULL AUTO_INCREMENT,
  `id_penilaian_kelompok` int(11) NOT NULL,
  `id_soal_kelompok` int(11) NOT NULL,
  `id_kelompok` int(11) NOT NULL,
  `id_ceklis` char(5) NOT NULL,
  `nilai` float NOT NULL,
  PRIMARY KEY (`id_detail_penilaian_kelompok`),
  KEY `id_penilaian_kelompok` (`id_penilaian_kelompok`),
  KEY `id_soal_kelompok` (`id_soal_kelompok`),
  KEY `id_kelompok` (`id_kelompok`),
  KEY `id_ceklis` (`id_ceklis`),
  CONSTRAINT `DETAIL_CEKLIS` FOREIGN KEY (`id_ceklis`) REFERENCES `ceklis` (`id_ceklis`),
  CONSTRAINT `DETAIL_KELOMPOK` FOREIGN KEY (`id_kelompok`) REFERENCES `kelompok` (`id_kelompok`),
  CONSTRAINT `DETAIL_PENILAIAN_KELOMPOK_ibfk_1` FOREIGN KEY (`id_penilaian_kelompok`) REFERENCES `penilaian_kelompok` (`id_penilaian_kelompok`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `DETAIL_PENILAIAN_KELOMPOK_ibfk_2` FOREIGN KEY (`id_soal_kelompok`) REFERENCES `soal_kelompok` (`id_soal_kelompok`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=82 DEFAULT CHARSET=utf8mb4;

-- Dumping data for table penilaian.detail_penilaian_kelompok: ~63 rows (approximately)
/*!40000 ALTER TABLE `detail_penilaian_kelompok` DISABLE KEYS */;
INSERT IGNORE INTO `detail_penilaian_kelompok` (`id_detail_penilaian_kelompok`, `id_penilaian_kelompok`, `id_soal_kelompok`, `id_kelompok`, `id_ceklis`, `nilai`) VALUES
	(6, 2, 1, 1, 'C12', 70),
	(7, 2, 2, 1, 'C12', 20),
	(8, 2, 3, 1, 'C12', 5),
	(9, 2, 4, 1, 'C12', 5),
	...
	(84, 22, 212, 3, 'C1', 30),
	(85, 22, 213, 3, 'C1', 10);
/*!40000 ALTER TABLE `detail_penilaian_kelompok` ENABLE KEYS */;

-- Dumping structure for table penilaian.detail_penilaian_perorangan
CREATE TABLE IF NOT EXISTS `detail_penilaian_perorangan` (
  `id_detail_penilaian_perorangan` int(11) NOT NULL AUTO_INCREMENT,
  `id_penilaian_perorangan` int(11) NOT NULL,
  `id_soal_perorangan` int(11) NOT NULL,
  `id_anggota` int(11) NOT NULL,
  `nilai` tinyint(4) NOT NULL,
  PRIMARY KEY (`id_detail_penilaian_perorangan`),
  KEY `id_penilaian_perorangan` (`id_penilaian_perorangan`),
  KEY `id_soal_perorangan` (`id_soal_perorangan`),
  KEY `id_anggota` (`id_anggota`),
  CONSTRAINT `DETAIL_PENILAIAN_PERORANGAN_ibfk_2` FOREIGN KEY (`id_soal_perorangan`) REFERENCES `soal_perorangan` (`id_soal_perorangan`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `DETAIL_PENILAIAN_PERORANGAN_ibfk_3` FOREIGN KEY (`id_penilaian_perorangan`) REFERENCES `penilaian_perorangan` (`id_penilaian_perorangan`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=180 DEFAULT CHARSET=utf8mb4;

-- Dumping data for table penilaian.detail_penilaian_perorangan: ~39 rows (approximately)
/*!40000 ALTER TABLE `detail_penilaian_perorangan` DISABLE KEYS */;
INSERT IGNORE INTO `detail_penilaian_perorangan` (`id_detail_penilaian_perorangan`, `id_penilaian_perorangan`, `id_soal_perorangan`, `id_anggota`, `nilai`) VALUES
	(141, 11, 1, 527, 8),
	(142, 11, 2, 527, 7),
	(143, 11, 3, 527, 2),
	(144, 11, 4, 527, 8),
	...
	(178, 13, 23, 572, 8),
	(179, 13, 24, 572, 8);
/*!40000 ALTER TABLE `detail_penilaian_perorangan` ENABLE KEYS */;

-- Dumping structure for table penilaian.jabatan
...
-- Dumping data for table penilaian.jabatan: ~10 rows (approximately)
/*!40000 ALTER TABLE `jabatan` DISABLE KEYS */;
INSERT IGNORE INTO `jabatan` (`id_jabatan`, `nama_jabatan`) VALUES
	(9, 'Panglima'),
	(10, 'Wapang'),
	(11, 'Staf Ahli'),
	(12, 'Asintel'),
...
-- Dumping structure for table penilaian.kelompok
...
-- Dumping data for table penilaian.kelompok: ~8 rows (approximately)
/*!40000 ALTER TABLE `kelompok` DISABLE KEYS */;
INSERT IGNORE INTO `kelompok` (`id_kelompok`, `nama_kelompok`) VALUES
	(1, 'KOGASGABPAD A'),
	(2, 'KOGASGABPAD B'),
	(3, 'KOGASGABPAD C'),
	(4, 'KOGASGABPAD D'),
...
-- Dumping structure for table penilaian.pangkat
...
-- Dumping data for table penilaian.pangkat: ~11 rows (approximately)
/*!40000 ALTER TABLE `pangkat` DISABLE KEYS */;
INSERT IGNORE INTO `pangkat` (`id_pangkat`, `nama_pangkat`) VALUES
	(1, 'Kolonel Inf'),
	(2, 'Kolonel Pnb'),
	(3, 'Kolonel Laut (P)'),
	(4, 'Kolonel Arh'),
...
-- Dumping structure for table penilaian.penilaian_kelompok
CREATE TABLE IF NOT EXISTS `penilaian_kelompok` (
  `id_penilaian_kelompok` int(11) NOT NULL AUTO_INCREMENT,
  `id_kelompok` int(11) NOT NULL,
  `id_ceklis` char(5) NOT NULL,
  `tgl` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `ket` varchar(255) NOT NULL,
  PRIMARY KEY (`id_penilaian_kelompok`),
  KEY `id_kelompok` (`id_kelompok`),
  KEY `id_ceklis` (`id_ceklis`),
  CONSTRAINT `PENILAIAN_KELOMPOK_ibfk_1` FOREIGN KEY (`id_kelompok`) REFERENCES `kelompok` (`id_kelompok`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `PENILAIAN_KELOMPOK_ibfk_2` FOREIGN KEY (`id_ceklis`) REFERENCES `ceklis` (`id_ceklis`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8mb4;

-- Dumping data for table penilaian.penilaian_kelompok: ~17 rows (approximately)
/*!40000 ALTER TABLE `penilaian_kelompok` DISABLE KEYS */;
INSERT IGNORE INTO `penilaian_kelompok` (`id_penilaian_kelompok`, `id_kelompok`, `id_ceklis`, `tgl`, `ket`) VALUES
...
/*!40000 ALTER TABLE `penilaian_kelompok` ENABLE KEYS */;

-- Dumping structure for table penilaian.penilaian_perorangan
CREATE TABLE IF NOT EXISTS `penilaian_perorangan` (
  `id_penilaian_perorangan` int(11) NOT NULL AUTO_INCREMENT,
  `id_anggota` int(11) NOT NULL,
  `id_ceklis` char(5) NOT NULL,
  `tanggal` date NOT NULL,
  PRIMARY KEY (`id_penilaian_perorangan`),
  KEY `id_anggota` (`id_anggota`),
  KEY `id_ceklis` (`id_ceklis`),
  CONSTRAINT `PENILAIAN_PERORANGAN_ibfk_2` FOREIGN KEY (`id_anggota`) REFERENCES `anggota` (`id_anggota`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `PENILAIAN_PERORANGAN_ibfk_4` FOREIGN KEY (`id_ceklis`) REFERENCES `ceklis` (`id_ceklis`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4;

-- Dumping data for table penilaian.penilaian_perorangan: ~3 rows (approximately)
/*!40000 ALTER TABLE `penilaian_perorangan` DISABLE KEYS */;
INSERT IGNORE INTO `penilaian_perorangan` (`id_penilaian_perorangan`, `id_anggota`, `id_ceklis`, `tanggal`) VALUES
	(11, 527, 'C2', '2020-07-21'),
	(12, 576, 'C5', '2020-07-21'),
	(13, 572, 'C3', '2020-07-21');
/*!40000 ALTER TABLE `penilaian_perorangan` ENABLE KEYS */;

-- Dumping structure for table penilaian.soal_kelompok
CREATE TABLE IF NOT EXISTS `soal_kelompok` (
  `id_soal_kelompok` int(11) NOT NULL AUTO_INCREMENT,
  `maks` float NOT NULL,
  `id_ceklis` char(5) NOT NULL,
  `aspek` varchar(255) NOT NULL,
  `tipe_nilai` tinyint(4) NOT NULL,
  `is_aktif` tinyint(4) NOT NULL DEFAULT '1',
  PRIMARY KEY (`id_soal_kelompok`),
  KEY `id_ceklis` (`id_ceklis`),
  CONSTRAINT `SOAL_KELOMPOK_ibfk_1` FOREIGN KEY (`id_ceklis`) REFERENCES `ceklis` (`id_ceklis`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=214 DEFAULT CHARSET=utf8mb4;

-- Dumping data for table penilaian.soal_kelompok: ~189 rows (approximately)
/*!40000 ALTER TABLE `soal_kelompok` DISABLE KEYS */;
INSERT IGNORE INTO `soal_kelompok` (`id_soal_kelompok`, `maks`, `id_ceklis`, `aspek`, `tipe_nilai`, `is_aktif`) VALUES
...
/*!40000 ALTER TABLE `soal_kelompok` ENABLE KEYS */;

-- Dumping structure for table penilaian.soal_perorangan
CREATE TABLE IF NOT EXISTS `soal_perorangan` (
  `id_soal_perorangan` int(11) NOT NULL AUTO_INCREMENT,
  `id_ceklis` char(5) NOT NULL,
  `indeks` tinyint(4) NOT NULL,
  `tindakan_macam` text NOT NULL,
  `nilmax` varchar(5) NOT NULL,
  `is_aktif` tinyint(1) NOT NULL DEFAULT '1',
  PRIMARY KEY (`id_soal_perorangan`),
  KEY `id_ceklis` (`id_ceklis`),
  CONSTRAINT `SOAL_PERORANGAN_ibfk_1` FOREIGN KEY (`id_ceklis`) REFERENCES `ceklis` (`id_ceklis`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=166 DEFAULT CHARSET=utf8mb4;

-- Dumping data for table penilaian.soal_perorangan: ~164 rows (approximately)
/*!40000 ALTER TABLE `soal_perorangan` DISABLE KEYS */;
INSERT IGNORE INTO `soal_perorangan` (`id_soal_perorangan`, `id_ceklis`, `indeks`, `tindakan_macam`, `nilmax`, `is_aktif`) VALUES
...
/*!40000 ALTER TABLE `soal_perorangan` ENABLE KEYS */;

-- Dumping structure for table penilaian.user
...
-- Dumping data for table penilaian.user: ~20 rows (approximately)
/*!40000 ALTER TABLE `user` DISABLE KEYS */;
INSERT IGNORE INTO `user` (`id_user`, `nama_user`, `username`, `password`, `level`, `akses`, `akses_kelompok`, `id_anggota`, `status`) VALUES
